          ...
          <form class="needs-validation" novalidate="" method="post" action="nuevoregistro.php">
            <div class="row">
              <div class="col-4 col-md-4 mb-3">
                ...
                <input type="character varying" class="form-control" id="nombreusuario" name="nombreusuario" placeholder="Nombre y Apellido" value="" required="">
              ...
              <div class="col-4 col-md-4 mb-3">
                ...
                <input type="integer" class="form-control" id="cedulausuario" name="cedula" placeholder="Cedula (Sin puntos ni espacios)" value="" required="">
                <div class="invalid-feedback">
            ...
            <div class="row">              
              ...
              <div class="col-4 col-md-4 mb-3">
                ...
                <input type="character varying" class="form-control" id="username" name="username" placeholder="Username" value="" required="">
                <div class="invalid-feedback">
              ...
              <div class="col-4 col-md-4 mb-3">
                ...
                <input type="character varying" class="form-control" id="password" name="password" placeholder="Password" value="" required="">
                <div class="invalid-feedback">
